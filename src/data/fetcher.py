...
class DatasetFetcher:
    ...
    def download_dataset(self, hq_files=True):
        ...
        destination_path = os.getenv("DATA_PATH_0") + "/"
        ...
        datasets_path = [destination_path + "train" + prefix + "/images", destination_path + "test" + prefix + "/images",
                         destination_path + "metadata.csv", destination_path + "train_masks.csv",
                         destination_path + "train" + prefix + "/masks"]
        ...
        for dir_path in datasets_path:
            ...
            if not os.path.exists(dir_path):
                print("WARN: DataFolder Not Found:" + dir_path)
    ...
    def get_car_image_files(self, car_image_id, test_file=False, get_mask=False):
        ...
        raise Exception("No image with this ID found:" + car_image_id)
